        ...
        for pages in count(1, 1) :
            ...
            try:
                for pu in people_url:
                    ...
                    ntitle_list = []
                    ntitle = soup_naver.find_all('span', {'class': 'tit_main _text'})
                    ...
                    for title in ntitle_list:
                        if title in ptitle_list:
                            ...
                            print("[NIFO] {} - 동일 작품이 발견되었습니다.".format(title))
                            raise NotImplementedError
                        else:
                            pass
            except:
            ...
            try :
                naver_drv.find_element_by_class_name('next').click()
            except :
                break
