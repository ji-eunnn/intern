...
file_list2 = os.listdir(f'/Users/jieun/Desktop/스타 이미지 편집본_{now_year}{now_month}{now_day}')
# file_list2 = os.listdir(f'/Users/mycelebs/Desktop/스타이미지_편집본_210503')
for j in file_list2:
    try:
        filedir = f'/Users/jieun/Desktop/스타 이미지 편집본_{now_year}{now_month}{now_day}/{j}/'
        # filedir = f'/Users/mycelebs/Desktop/스타이미지_편집본_210503/{j}/'
        file_list = os.listdir(f'/Users/jieun/Desktop/스타 이미지 편집본_{now_year}{now_month}{now_day}/{j}')
        ...
        for i in file_list:
            try:
                ...
                img2.save(f'/Users/jieun/Desktop/스타 이미지 편집본_{now_year}{now_month}{now_day}/{j}/{i[:-4]}.jpg')
