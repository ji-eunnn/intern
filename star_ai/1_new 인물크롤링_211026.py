...
naver_id = naver_id + '프로필'

empty_frame = pd.DataFrame(columns=('이름', '기본 분류', '성별', '검색어', '매칭 단어', '내부 검색식', '본명/영어이름', '직업', '키', '몸무게', '체질량지수', 'BMI 범위', '양력생일', '양력생일_', '음력생일', '별자리',  '띠', '나이(만)', '혈액형', '출생지', '사망일', '소속사', '소속', '소속팀', '가족', '그룹', '데뷔', '그룹/팀 여부', '멤버', '학력', '경력', '수상', '동의어', '사망 여부', '네이버 인물 id', '네이버 영화 인물 id', '다음 인물 id', '광고정보센터 인물 id', '플레이디비 인물 id', '바이브 인물 id', '공식사이트 [Official site]', '팬카페 [Fan Cafe]', '블로그 [Blog]', '미니홈피 [MiniHomepage]', '트위터 [Twitter]', '페이스북 [Facebook]', '인스타그램 [Instagram]', '유튜브 [Youtube]', '웨이보 [Weibo]', '텀블러 [tumblr]', '카카오스토리 [kakaostory]', '네이버캐스트 [NaverCast]', '브이라이브 [V LIVE]', '네이버토크 [NaverTalk]', '업데이트일'))
