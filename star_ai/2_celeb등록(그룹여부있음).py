...
# /Users/mycelebs_13/Desktop/방송.홍채원/익디
# star_excel = pd.read_excel('익디 등록.xlsx')
...
#driver = webdriver.Chrome(chrome_options=chrome_options, executable_path='/Users/mycelebs_13/Desktop/방송.홍채원/익디/chromedriver.exe')
...
if bQueryError is False:
    for i in tqdm(range(len(name))):
        ...
        if group_flag[i] == 1 :
            ...
            color_hex_group = ['list_group[0][0]', 'list_group[0][1]']
        ...
        driver.find_element_by_xpath('//*[@id="s_cd_match_word"]').send_keys(name[i])
