...
for j, row in tqdm(pro_excel.iterrows(), total=pro_excel.shape[0]) :
    i = int(row['cd_idx'])
    name = row['name']
    ...
    try :
        ...
        try:
            ...
            try:
                driver.find_element_by_css_selector('#celeb_image_1').send_keys(
                    '/Users/jieun/Desktop/업무/인물등록/아카이브/이미지등록전/' + str(day) + '/' + str(i) + '_sq.png')  # 640x414 I/O 작업 실행
            except:
                driver.find_element_by_css_selector('#celeb_image_1').send_keys(
                    '/Users/jieun/Desktop/업무/인물등록/아카이브/이미지등록전/' + str(day) + '/' + str(i) + '_sq.jpeg')
...
nullDf.to_excel("/Users/jieun/Desktop/업무/인물등록/null_data/null_image_list_"+timelabel+".xlsx", index=False)
